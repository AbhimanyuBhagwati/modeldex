...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${SITE.url}/galaxy/`, lastModified: updated, changeFrequency: 'daily', priority: 0.8 },
    { url: `${SITE.url}/credits/`, lastModified: updated, changeFrequency: 'monthly', priority: 0.3 },
